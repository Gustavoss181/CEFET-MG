...
//legenda
		...
		public void run() {
			while(true) {
				...
				if(c.pause) {
					...
					//energias
					Ec.setBounds(Ec.getX(), 550-c.bolinha.getEPG(), Ec.getWidth(), c.bolinha.getEPG());
					Epg.setBounds(Epg.getX(), 550-c.bolinha.getEC(), Epg.getWidth(), c.bolinha.getEC());
	...
	//Controle Altura
		...
		labelA.setBounds(1090, 200, 90, 32);
