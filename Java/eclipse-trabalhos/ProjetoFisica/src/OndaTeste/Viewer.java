...
public class Viewer extends JFrame{
	...
	public Viewer(double f, int A, int nAtomos, int tempo, int tipoMove, double duracaoPulso, int fase) {
		c = new Control(f, A, nAtomos, tempo, tipoMove, duracaoPulso, fase);
